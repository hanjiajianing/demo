...
<div style="position: absolute;left: 300px;top: 100px;">
    ...
    <button><a href="<%=request.getContextPath()%>/output.Course">导出</a></button>
    <br><br>
    <button><a href="<%=request.getContextPath()%>/CourseAdmin/addCourse.jsp ">添加</a></button>
    <%
        List<OptionalCourse> courseList = (List<OptionalCourse>)request.getAttribute("courseList");
//        User user =(User) request.getAttribute("user");
    ...
    <table border="1" cellpadding="0" cellspacing="0" class="table table-striped">
        ...
        <%
            for(OptionalCourse optionalCourse : courseList){
        %>
...
<%--                <a href="delete.UserCourse?courseId=<%= optionalCourse.getCourseId()%>&username=<%=user.getUsername()%>">Delete</a>--%>
     <a href="delete.Course?courseId=<%=optionalCourse.getCourseId()%> ">Delete</a>
            </td>
        </tr>
